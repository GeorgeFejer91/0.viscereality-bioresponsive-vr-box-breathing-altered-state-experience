...
- The canonical review build completes successfully at 51 manuscript pages and 17 Online Resource pages. Final logs contain no undefined citations or references, duplicate labels, overfull boxes, or fatal errors. The pages containing the amended Bayesian method, restored Figure 7 referral, Table S5, and Table S9 were rendered and visually verified without clipping, overlap, or illegible content.
